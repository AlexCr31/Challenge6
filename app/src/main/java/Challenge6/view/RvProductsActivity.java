...
import Challenge6.adapter.AdapterRvProducts;
import Challenge6.entities.ProductResult;
import Challenge6.utils.ApiClient;
import Challenge6.utils.ApiInterface;
    ...
    private void initData() {
        ...
        call.enqueue(new Callback<ArrayList<ProductResult>>() {
            ...
            public void onResponse(Call<ArrayList<ProductResult>> call, Response<ArrayList<ProductResult>> response) {
                ...
                Toast.makeText(RvProductsActivity.this, "Got Prodcts", Toast.LENGTH_SHORT).show();
